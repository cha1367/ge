...
""",
    ...
    st.markdown(
        f"""
<div class="connector">
    계산식: 쉬었음 청년 수 × 271만원(세전) × 12개월 × 9%<br>
...
def page_policy() -> None:
    ...
    st.markdown(
        f"""
<div class="connector">
    쉬었음 청년이 늘면 뭐가 달라질까. 이 대시보드는 그 질문에서 출발했다.<br><br>
    일을 안 하면 소득이 없다. 소득이 없으면 소비도 줄고, 연금도 안 낸다.
    개인 문제처럼 보이지만 40만명 규모로 쌓이면 <strong>노동시장, 경제, 재정 전체로 번진다.</strong><br><br>
    수치는 추정이다. 하지만 방향은 명확하다.
    돈 더 주는 정책보다 <strong>일할 수 있는 경로를 만드는 게</strong> 핵심이다.
</div>
""",
        unsafe_allow_html=True,
    )
...
<div class="policy-grid-card">
    ...
    <div class="policy-title">쉬는 기간이 길수록<br>이탈이 고착된다</div>
    <div class="policy-desc">
        2025년 비경활 청년 중 쉬었음 비율이 19.9%다.
        2020년 이후 이 비율이 계속 올라가고 있다.
        한번 빠지면 다시 돌아오기 어려운 구조가 문제다.
    </div>
    <ul>
        <li>2015년 12.0% → 2025년 19.9%로 증가</li>
        <li>쉬는 기간이 길수록 재진입 더 어려워짐</li>
        <li>일시적 휴식이 장기 비경활로 고착되는 경로</li>
        <li>핵심: 이탈 초기에 잡지 않으면 늦는다</li>
    </ul>
</div>
""",
            unsafe_allow_html=True,
...
<div class="policy-grid-card">
    ...
    <div class="policy-desc">
        일 안 하면 돈이 없고, 돈이 없으면 소비도 없다.
        쉬었음 청년이 40만명이 넘는다는 건 그만큼의 소비 주체가 시장에서 빠진다는 뜻이다.
...
<div class="policy-grid-card">
    ...
    <div class="policy-desc">
        일 안 하면 연금도 안 낸다.
        2022년부터 20대 고용보험 피보험자가 3년 연속 줄고 있다.
        취업해도 3개월 만에 나오면 재정엔 아무 도움이 안 된다.
...
<div class="policy-final-box">
    <h3>데이터가 가리키는 방향: 일할 수 있는 경로를 만들어라</h3>
    <p>
        분석 결과는 세 가지를 보여준다.<br>
        쉬었음 청년이 늘고 있고, 소비 공백이 커지고 있고, 고용보험 피보험자는 줄고 있다.<br><br>
        공통점은 하나다. <strong>일을 안 하고 있다는 것.</strong><br>
        그러면 해법도 하나다. 일할 수 있는 경로를 만드는 것.<br><br>
        돈 더 주는 정책은 이미 많다. 근데 쉬었음 청년은 계속 늘고 있다.
        문제는 <strong>첫 발을 내딛을 경로 자체가 막혀있다</strong>는 거다.
    </p>
</div>
""",
        unsafe_allow_html=True,
...
<div class="policy-final-box">
    <h3>결론</h3>
    <p>
        쉬었음 청년이 늘어나는 건 개인 의지의 문제가 아니다.<br><br>
        데이터가 보여주는 건 이거다.<br>
        일 안 하는 청년이 늘수록 소비가 줄고, 연금 기반도 흔들린다.
        2025년 기준 소비 공백 추정만 수조원, 누적 연금 공백은 10조원이 넘는다.<br><br>
        해법은 간단하다. <strong>일할 수 있는 경로를 만들어라.</strong>
        첫 발을 내딛으면 소득이 생기고, 소득이 생기면 소비도 하고 연금도 낸다.
        지원금 늘리는 게 아니라 경로를 여는 게 먼저다.
    </p>
</div>
""",
        unsafe_allow_html=True,
...
<div class="metric-card">
    ...
    <div style="color:#ffffff; line-height:1.7; margin-top:0.6rem;">쉬었음 청년 수 × 271만원(세전) × 12개월 × 9%</div>
</div>
""",
            unsafe_allow_html=True,
        )
