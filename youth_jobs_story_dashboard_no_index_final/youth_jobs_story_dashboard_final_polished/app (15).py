...
if page == "프로젝트 개요":
    ...
    fig.update_layout(height=430, margin=dict(l=30, r=25, t=65, b=35), paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, font=dict(color=FONT_COLOR, family="Pretendard"), hoverlabel=dict(bgcolor="#0E1629", font_color="#E2E8F0", bordercolor=INDIGO))
    ...
    with col2:
        ...
        fig.update_layout(template=TEMPLATE, paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, barmode="stack", title=dict(text="청년 정규직·비정규직 규모", font=dict(color=TITLE_COLOR, family="Pretendard")), height=430, yaxis_title="천 명", xaxis_title="연도", font=dict(color=FONT_COLOR, family="Pretendard"), margin=dict(l=30, r=25, t=65, b=35), legend=dict(orientation="h", y=1.02, x=1, xanchor="right", yanchor="bottom", bgcolor="rgba(0,0,0,0)"), hoverlabel=dict(bgcolor="#0E1629", font_color="#E2E8F0", bordercolor=INDIGO))
        st.plotly_chart(fig, use_container_width=True)
    ...
    fig.update_layout(height=650, margin=dict(l=30, r=25, t=65, b=35), paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, font=dict(color=FONT_COLOR, family="Pretendard"), legend=dict(orientation="h", y=1.02, x=1, xanchor="right", yanchor="bottom", bgcolor="rgba(0,0,0,0)"), hoverlabel=dict(bgcolor="#0E1629", font_color="#E2E8F0", bordercolor=INDIGO))
    fig.update_xaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
    fig.update_yaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
    st.plotly_chart(fig, use_container_width=True)
    ...
    with col1:
        ...
        fig1.update_layout(height=440, margin=dict(l=30, r=20, t=60, b=30), paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, font=dict(color=FONT_COLOR, family="Pretendard"), hoverlabel=dict(bgcolor="#0E1629", font_color="#E2E8F0", bordercolor=INDIGO))
        fig1.update_xaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
        fig1.update_yaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
    ...
    with col2:
        ...
        fig2.update_layout(height=440, margin=dict(l=30, r=20, t=60, b=30), paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, font=dict(color=FONT_COLOR, family="Pretendard"), hoverlabel=dict(bgcolor="#0E1629", font_color="#E2E8F0", bordercolor=INDIGO))
        fig2.update_xaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
        fig2.update_yaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
    ...
    fig.update_layout(height=650, margin=dict(l=30, r=25, t=65, b=35), paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, font=dict(color=FONT_COLOR, family="Pretendard"), hoverlabel=dict(bgcolor="#0E1629", font_color="#E2E8F0", bordercolor=INDIGO))
    fig.update_xaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
    fig.update_yaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
    st.plotly_chart(fig, use_container_width=True)
    ...
    with col2:
        ...
        fig2.update_layout(height=520, margin=dict(l=30, r=25, t=65, b=35), paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, font=dict(color=FONT_COLOR, family="Pretendard"), hoverlabel=dict(bgcolor="#0E1629", font_color="#E2E8F0", bordercolor=INDIGO))
        fig2.update_xaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
        fig2.update_yaxes(gridcolor=GRID_COLOR, color=FONT_COLOR)
        st.plotly_chart(fig2, use_container_width=True)
    ...
    fig3 = px.imshow(
        heat,
        aspect="auto",
        color_continuous_scale=[[0, "#0A1020"], [0.3, "#1E3A8A"], [0.6, "#3B82F6"], [1.0, "#60A5FA"]],
        labels=dict(x="연도", y="시도", color="고용률(%)"),
        title="시도별 청년 고용률 heatmap",
    )
    fig3.update_layout(height=560, margin=dict(l=30, r=25, t=65, b=35), paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, font=dict(color=FONT_COLOR, family="Pretendard"))
    ...
    with col1:
        fig = line_chart(vuln, ["youth_employment_vulnerability_index"], "청년 고용 취약성 지수 추이", "0~100", {"youth_employment_vulnerability_index": "취약성 지수"}, height=430, show_periods=True)
        st.plotly_chart(fig, use_container_width=True)
    with col2:
    ...
    fig_corr = px.imshow(
        ...
        text_auto=".2f",
        zmin=-1, zmax=1,
        color_continuous_scale=[[0, "#F43F5E"], [0.5, "#0A1020"], [1.0, "#6366F1"]],
        title="주요 지표 상관관계 heatmap",
        labels=dict(color="상관계수"),
    )
    fig_corr.update_layout(height=640, margin=dict(l=30, r=25, t=65, b=35), paper_bgcolor=CHART_PAPER, plot_bgcolor=CHART_BG, font=dict(color=FONT_COLOR, family="Pretendard"))
