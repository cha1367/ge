...
<div class="connector">
    ...
    <strong>기업 미충원과 청년 비활동의 미스매치 → 첫 소득 부재와 소비 여력 약화 → 사회보험 편입 지연</strong>으로 이어질 수 있는 구조로 보는 것입니다.
    소비 공백과 국민연금 납부 공백은 실제 손실액이 아니라 잠재 추정치이고,
    경제 파트에서는 음식점 및 주점업 생산지수를 소비공백 추정액과 결합해 생활서비스 부담지수로 재구성했습니다.
</div>
""",
        unsafe_allow_html=True,
    )
...
<div class="policy-final-box">
    <h3>데이터 출처</h3>
    <p>
        <strong>쉬었음 청년 수·전체 비경제활동인구</strong>: KOSIS 경제활동인구조사<br>
        <strong>20~29세 취업자 수</strong>: KOSIS 경제활동인구조사, 연령별 경제활동인구 총괄<br>
        <strong>20~29세 주민등록인구</strong>: KOSIS 주민등록인구통계, 1세별 20~29세 합산<br>
        <strong>미충원인원</strong>: 고용노동통계 직종별사업체노동력조사, 산업별·규모별, 전국·전산업·5인 이상, 하반기(2/2) 기준<br>
        <strong>음식점 및 주점업 서비스업생산지수</strong>: KOSIS 서비스업동향조사, 산업별 서비스업생산지수, 불변지수(2020=100). 생활서비스 부담지수 계산에 사용<br>
        <strong>20대 고용보험 피보험자 수</strong>: EIS 고용행정통계 월별 피보험자현황, 연령 20~29세, 각 연도 12월 말 기준<br>
